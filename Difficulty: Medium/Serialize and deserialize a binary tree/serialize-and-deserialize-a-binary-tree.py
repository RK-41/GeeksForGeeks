...
class Solution:
    ...
    def serialize(self, root):
        ...
        self.travInorder(root, serialized)
        return serialized
    
    #Function to deserialize a list and construct the tree.   
    def deSerialize(self, arr):
        #code here
        return self.build(arr, 0, len(arr))
        
    def travInorder(self, node, serialized):
        if not node:    return
    
        self.travInorder(node.left, serialized)
        serialized.append(node.data)
        self.travInorder(node.right, serialized)
